...
Load data. 
```{r}
filename = "/Users/kelsey/Dropbox (UMass Medical School)/Kelsey/Lassa Fever/Data/2018-cleaned.csv"
...
write.csv(ag, "./lassa_fever_analysis/cfr_by_age.csv")
```
